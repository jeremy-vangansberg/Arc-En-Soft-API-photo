...
def create_image(
    ...
    x1: Optional[int] = Query(50, alias="x1", description="x coordinate 1 in %. Example: 50"),
    y1: Optional[int] = Query(50, alias="y1", description="y coordinate 1 in %. Example: 50"),
    r1: Optional[int] = Query(90, alias="r1", description="Rotation 1 in angle (clockwise). Example: 90"),
    w1: Optional[float] = Query(10, alias="w1", description="Width 1 in %. Example: 10.0"),
    c1: Optional[str] = Query('NB', alias="c1", description="Filter 1. Example: 'NB'"),
    db1: Optional[int] = Query(5, alias="db1", description="% of height to cut at the bottom 1. Example: 5"),
    dh1: Optional[int] = Query(5, alias="dh1", description="% of height to cut at the top 1. Example: 5"),
    ...
    c3: Optional[str] = Query(None, alias="c3", description="Filter 3. Example: 'NB'"),
    ...
    c4: Optional[str] = Query(None, alias="c4", description="Filter 4. Example: 'NB'"),
    ...
    c5: Optional[str] = Query(None, alias="c5", description="Filter 5. Example: 'NB'"),
    ...
    c6: Optional[str] = Query(None, alias="c6", description="Filter 6. Example: 'NB'"),
    ...
    c7: Optional[str] = Query(None, alias="c7", description="Filter 7. Example: 'NB'"),
    ...
    c8: Optional[str] = Query(None, alias="c8", description="Filter 8. Example: 'NB'"),
    ...
    c9: Optional[str] = Query(None, alias="c9", description="Filter 9. Example: 'NB'"),
    ...
    c10: Optional[str] = Query(None, alias="c10", description="Filter 10. Example: 'NB'"),
    ...
    t1: Optional[str] = Query('text1', alias="t1", description="Text 1. Example: 'Hello World'"),
    tx1: Optional[int] = Query(5, alias="tx1", description="Text x position 1 in %. Example: 5"),
    ty1: Optional[int] = Query(5, alias="ty1", description="Text y position 1 in %. Example: 5"),
    tf1: Optional[str] = Query('arial', alias="tf1", description="Font 1. Example: 'NB'"),
    ...
    t2: Optional[str] = Query('text2', alias="t2", description="Text 2. Example: 'Bonjour le monde'"),
    tf2: Optional[str] = Query('tnr', alias="tf2", description="Font 2. Example: 'times new roman'"),
    tc2: Optional[str] = Query('FFFFFF', alias="tc2", description="Text color 2. Hex format. Example: 'FFFFFF'"),
    tt2: Optional[int] = Query(15, alias="tt2", description="Text size 2. Example: 15"),
    tx2: Optional[int] = Query(50, alias="tx2", description="Text x position 2 in %. Example: 50"),
    ty2: Optional[int] = Query(5, alias="ty2", description="Text y position 2 in %. Example: 5")
):
